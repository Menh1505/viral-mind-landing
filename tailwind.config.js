...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        "display-xl": ["clamp(1.875rem, 4.5vw + 0.5rem, 4.25rem)", { lineHeight: "1.12", letterSpacing: "-0.03em", fontWeight: 700 }],
        "display-lg": ["clamp(1.5rem, 3.5vw + 0.5rem, 3rem)", { lineHeight: "1.2", letterSpacing: "-0.02em", fontWeight: 700 }],
        "display-md": ["clamp(1.25rem, 2.5vw + 0.5rem, 2.25rem)", { lineHeight: "1.25", fontWeight: 600 }],
        "display-sm": ["clamp(1.125rem, 2vw + 0.4rem, 1.75rem)", { lineHeight: "1.3", fontWeight: 600 }],
