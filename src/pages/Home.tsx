  ...
  return <div className="min-h-screen bg-viral-bg text-viral-text font-body">
    ...
    <main id="main-content">
      <section id="overview" className="relative min-h-screen overflow-hidden pt-28 pb-20 flex items-center">
        ...
        <div className="container relative z-10 grid lg:grid-cols-[0.9fr_1.1fr] gap-12 items-center">
          <motion.div initial={{opacity:0,y:28}} animate={{opacity:1,y:0}} transition={{duration:.7}}>
            ...
            <h1 className="font-display text-display-xl mt-5 mb-6">Một đội ngũ AI phối hợp vận hành quy trình <span className="text-gradient-accent">Digital Marketing dành riêng cho bạn.</span></h1>
            <p className="text-body-lg text-viral-text-muted max-w-xl mb-8">ViralMinds phối hợp nhiều AI Specialist trong một quy trình thống nhất, để đội ngũ của bạn triển khai nhanh hơn mà vẫn kiểm soát những quyết định quan trọng.</p>
      ...
      <section id="capabilities" className="py-20 relative scroll-mt-16">
        ...
        <div className="container"><div className="max-w-3xl mx-auto text-center mb-12"><span className="section-label">ViralMinds giúp bạn làm những gì?</span><h2 className="section-title">Mỗi bài toán Marketing được phụ trách bởi một nhóm AI Specialist phù hợp.</h2><p className="section-subtitle mx-auto mt-4">Chọn một nhóm để xem vấn đề thường gặp và cách ViralMinds thực hiện.</p></div>
